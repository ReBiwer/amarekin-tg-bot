...
class Settings(BaseSettings):
    ...
    START_MESSAGE: str = (
        ...
        'Мы собираем базу данных статей и материалов экспертов в вопросах родительства и ответы нашего бота -'
        ' это не просто поиск по всему интернету - это выдача именно из проверенных эксперных материалов.\n\n'
